...
<body>
    ...
    <hr />
    <br>
    <p align="center"> <b>DATA LAPORAN PEMBELIAN BAHANBAKU :</b> <b style="color:blue"><?php echo $tanggalawal1 ?></b> - <b style="color:blue"><?php echo $tanggalakhir1 ?></b> </p>
    <table id="tabel2" class="tabel2" align="center" width="100%" cellspacing="0">
        <thead style="text-align: center; background-color:#C1C1C1">
            <tr>
                ...
                <td style="text-align: center; background-color:#f5f5f5">Nama Petani</td>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM tb_pembelian_bahanbaku a JOIN tb_bahanbaku b ON a.id_bahanbaku = b.id_bahanbaku JOIN tb_petani c ON a.id_petani = c.id_petani WHERE  a.tanggal_pembelian BETWEEN '$tanggalawal' AND ' $tanggalakhir' ORDER BY a.id_pembelian ASC;";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                <col width='140'>
                  <td style='text-align: center'>" . $data['nama_petani'] . "</td>
