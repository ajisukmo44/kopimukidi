...
<body>
    ...
    <hr />
    <br>
    <p align="center"> <b>DATA LAPORAN PRODUKSI :</b> <b style="color:blue"><?php echo $tanggalawal1 ?></b> - <b style="color:blue"><?php echo $tanggalakhir1 ?></b> </p>
    <table id="tabel2" class="tabel2" align="center" width="100%" cellspacing="0">
        <thead style="text-align: center; background-color:#C1C1C1">
            <tr>
                ...
                <td style="text-align: center; background-color:#f5f5f5">Tgl Produksi</td>
                ...
                <td style="text-align: center; background-color:#f5f5f5">Jumlah Bahanbaku</td>
                <td style="text-align: center; background-color:#f5f5f5">Stok Baru</td>
            </tr>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM tb_produksi a JOIN tb_produk b ON a.id_produk = b.id_produk JOIN tb_bahanbaku c ON a.id_bahanbaku = c.id_bahanbaku  ORDER BY status_produksi";

            $result = mysqli_query($conn, $sql);
            $no = 1;
            if (mysqli_num_rows($result) > 0) {
                while ($data = mysqli_fetch_array($result)) {
                    $tanggal = date('d-m-Y', strtotime($data['tanggal_produksi']));
                ...
                <col width='100'>
                  <td style='text-align: center'>" . $data['jumlah_bahanbaku'] . " Kg </td>
                  
                <col width='70'>
                  <td style='text-align: center'>" . $data['jumlah_stok_baru'] . " Pcs</td>
                </tr>";
                    $no++;
                }
            } else {
