...
?>
    ...
    <body>
        ...
        <table class="tabel2 table-responsive" cellspacing="0" cellpadding="4" align="center">
            <tr style="background-color:#E8E9EF; color:#000">
                <col width="10">
        ...
        if ($i['status_pemesanan'] == 0) {
            echo "<a href='#' ><span class='btn btn-danger btn-sm'>Gagal</span></a>";
        } elseif ($i['status_pemesanan'] == 1) {
            echo "<a href='#' ><span class='btn btn-danger btn-sm'>Belum Dibayar</span></a>";
        } elseif ($i['status_pemesanan'] == 2) {
            echo "<a href='#' ><span class='btn btn-warning btn-sm'>Sedang Diproses</span></a>";
        } elseif ($i['status_pemesanan'] == 3) {
            echo "<a href='#' ><span class='btn btn-success btn-sm'>Dalam Pengemasan</span></a>";
        } elseif ($i['status_pemesanan'] == 4) {
            echo "<a href='#' ><span class='btn btn-info btn-sm'>Sudah Dikirim</span></a>";
        } elseif ($i['status_pemesanan'] == 5) {
            echo "<a href='#' ><span class='btn btn-success btn-sm'> Selesai </span></a>";
        }
        ?>
    <?php
}
